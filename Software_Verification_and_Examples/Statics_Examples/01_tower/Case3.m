...
N=[10 -5 -5 8.6603 -8.6603 -1.836 5 -10 5; 0 8.6603 -8.6603 5 5 -10 8.6603 1.224 -8.6603; 0 0 0 30 30 30 60 60 60];
...
R3Ddata.Bradius=interp1([min(radius),max(radius)],[9.5,10],r_b);
R3Ddata.Sradius=interp1([min(radius),max(radius)],[1,1.6],r_s);
